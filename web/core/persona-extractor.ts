...
// nickname 매핑을 수집해 다음 단계로 push. document_start 시점에 inject 되어 *fetch 가 page script
// 보다 먼저* 가로채야 누락이 없다 (iOS WKUserScript.atDocumentStart / Android WebViewClient.onPageStarted /
// Chrome manifest world:"MAIN" / Safari ext injector.js 동적 inject).
//
// 4 플랫폼 모두 사용 — adapter.pushPersonaMap 만 platform-specific (native bridge / window.postMessage),
